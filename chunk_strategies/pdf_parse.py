...
"""
 This is taken from RagFlow: https://github.com/infiniflow/ragflow
 Though only the basics -> None of the advanced parsing was copied

 The goal is to capture the hierarchical structure of the paper when parsing.
 Currently regardless of semantic or recursive chunking, there's too much noise
 as well as a failure to capture the structure of the paper.
 Additionally, we arent capturing tables or images properly either.

 As a project I will fill the rest of this functionality out myself
 But it currently isnt ready.
"""
